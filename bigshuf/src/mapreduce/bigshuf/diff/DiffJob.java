...
public class DiffJob extends Configured implements Tool {
	...
	public int run(String[] arg0) throws Exception {
		...
		FileOutputFormat.setOutputPath(job, new Path("/home/mark/Desktop/Big_data/diff"));
		...
		if (job.waitForCompletion(true)) {
			...
			Logger l = Logger.getLogger(DiffJob.class.getName());
	...
	public static void main(String[] args) throws Exception {
		FileUtils.deleteDirectory(new File("//home/mark//Desktop//Big_data/diff"));
		DiffJob j = new DiffJob();
